...
\tikzstyle{abstract}=[rectangle, draw=black, rounded corners, fill=blue!40, drop shadow,
        text centered, anchor=north, text=white, text width=3.3cm]
\tikzstyle{comment}=[rectangle, draw=black, rounded corners, fill=gray, drop shadow,
...
\begin{tikzpicture}[node distance=2cm]
    ...
    \node (AuxNode01) [text width=4.0cm, below=of PD] {};


    \node (Construction) [abstract, rectangle split, rectangle split parts=2, left=of AuxNode01]
        {
            \textbf{CONSTRUCTION}
            \nodepart{second}nil
        };
...
%% Technical Office
    ...
    \node (AuxNode02) [text width=0.5cm, below=of Construction] {};
...
\node (CADTeamPlumbing) [comment, rectangle split, rectangle split parts=2, below=0.2cm of CADTeamElectrical, text justified]
    ...
    \draw[myarrow] (Sensor.north) -- ++(0,0.8) -| (Construction.south);
