...
\usepackage{soul,amsmath,xstring,coollist,siunitx, caption,expl3}
...
%  We take care that units and numbers do not break across lines
%  and they are separated by a thin space.
\def\aunit#1#2{\hbox{#1\kern.5pt#2}}
...
\input{./sections/romanunits}

\chapter{Other European Countries}
\newthought{Bologna}
